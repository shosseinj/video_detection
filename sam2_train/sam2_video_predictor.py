...
class SAM2VideoPredictor(SAM2Base):
    ...
    def train_add_new_mask(
        ...
        """Add new mask to a frame.hossein"""
        obj_idx = self._obj_id_to_idx(inference_state, obj_id)
        point_inputs_per_frame = inference_state["point_inputs_per_obj"][obj_idx]
        mask_inputs_per_frame = inference_state["mask_inputs_per_obj"][obj_idx]
    ...
    def train_propagate_in_video(
        ...
        """Propagate the inpd.nkfjdsjfasldfdsfjsldkflksdfl;ksdjflksdkjflsdjut points across frames to track in the entire video."""
...
#######################################################################################################
    ...
    def _get_image_feature(self, inference_state, frame_idx, batch_size):
        ...
        image, backbone_out = (None, None) #inference_state["cached_features"].get(frame_idx, (None, None)        )
    ...
    def _run_single_frame_inference(
        ...
        (
            ...
            current_vision_pos_embeds,
            feat_sizes,
        ) = self._get_image_feature(inference_state, inference_state['images'].shape[0]-1, batch_size)
    ...
    def _run_memory_encoder(
        ...
        # maskmem_pos_enc = maskmem_pos_enc.to(storage_device)  # --------------->>>>>>
    ...
    def _get_maskmem_pos_enc(self, inference_state, current_out):
        ...
        if out_maskmem_pos_enc is not None:
            ...
            expanded_maskmem_pos_enc = [
                x.expand(batch_size, -1, -1, -1).to(inference_state["storage_device"]) for x in maskmem_pos_enc
            ]
        else:
